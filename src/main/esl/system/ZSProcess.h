#ifndef ESL_SYSTEM_ZSPROCESS_H_
#define ESL_SYSTEM_ZSPROCESS_H_
...
class ZSProcess : public Process {
public:
	struct Settings {
		Settings() = default;
	...
	ZSProcess(const Settings& settings);
